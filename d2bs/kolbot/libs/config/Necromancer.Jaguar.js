...
function LoadConfig() {
	...
	*/
	...
	Config.QuitList = ["Maserati", "McLaren", "Ferrari", "Saleen", "Ascari", "Lotus"]; // List of character names to quit with. Example: Config.QuitList = ["MySorc", "MyDin"];
	...
	*/
	...
	Config.Curse[0] = 76; // Boss curse. Use skill number or set to 0 to disable.
