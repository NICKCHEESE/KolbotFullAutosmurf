...
function LoadConfig() {
	...
	*/
	...
	Config.QuitList = ["Maserati", "McLaren", "Saleen", "Jaguar", "Ascari", "Ferrari"]; // List of character names to quit with. Example: Config.QuitList = ["MySorc", "MyDin"];
	...
	*/
	...
	Config.ItemInfoQuality = [3, 4, 5, 6, 7, 8]; // The quality of sold items to log. See NTItemAlias.dbl for values. Example: Config.ItemInfoQuality = [6, 7, 8];
	...
	Config.AutoBuild.Template = "Javazon";	//	The name of the build associated with an existing
