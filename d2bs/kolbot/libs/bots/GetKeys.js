function GetKeys() {
	...
	if (!me.findItems("pk1") || me.findItems("pk1").length < 3) {
		try {
			print("ÿc4GetKeys ÿc0:: ÿc2Countess");
			...
			print("ÿc4GetKeys ÿc0:: ÿc1Countess failed");
		}
	}

	if (!me.findItems("pk2") || me.findItems("pk2").length < 3) {
		try {
			print("ÿc4GetKeys ÿc0:: ÿc2Summoner");
			Town.goToTown();
			Town.doChores();
			...
			print("ÿc4GetKeys ÿc0:: ÿc1Summoner failed");
		}
	}

	if (!me.findItems("pk3") || me.findItems("pk3").length < 3) {
		try {
			print("ÿc4GetKeys ÿc0:: ÿc2Nihlathak");
			Town.goToTown();
			Town.doChores();
			...
			print("ÿc4GetKeys ÿc0:: ÿc1Nihlathak failed");
		}
	}
}